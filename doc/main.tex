...
\begin{tabular}{ | l | l | l | }
  ...
  \hline                       
  $\omega_{left}$ & $[rad/s]$ & Rotational velocity of the left wheel. \\
  \hline                       
  $\omega_{right}$ & $[rad/s]$ & Rotational velocity of the right wheel. \\
  \hline                       
...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  \node[main node] (5) [above of=C] {local planner};
  ...
  \node[font=\bf] at ($(3.north east)+(0.6,0.6) $) {Motion control};
...
For slam the standard package \rospackage{gmapping} [1] can be used. 
...
\section{Navigation}
This chapter describes the general case of navigation.
