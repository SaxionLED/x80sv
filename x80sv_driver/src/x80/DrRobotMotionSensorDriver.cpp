...
namespace DrRobot
{
    ...
    MotionSensorDriver::MotionSensorDriver(CommInterface& commInterface) :
       _commInterface(commInterface)
    {

        _commInterface.registerHandler(this);
    ...
    void MotionSensorDriver::debug_ouput(const char* errorstr)
    {
    #ifdef DEBUG_ERROR
    ...
    unsigned char MotionSensorDriver::CalculateCRC(const unsigned char *lpBuffer, const int nSize)
    {
    ...
    void MotionSensorDriver::DealWithPacket(const unsigned char *lpComData, const int nLen)
    {
    ...
    void MotionSensorDriver::handleComData(const unsigned char *data, const int nLen) {
    ...
    void MotionSensorDriver::debugCommMessage(std::string msg)
    {
    #ifdef DEBUG_ERROR
    ...
    void MotionSensorDriver::getDrRobotMotionDriverConfig(DrRobotMotionConfig* driverConfig) {
    ...
    void MotionSensorDriver::setDrRobotMotionDriverConfig(DrRobotMotionConfig* driverConfig) {
    ...
    int MotionSensorDriver::readMotorSensorData(MotorSensorData* motorSensorData) {
        pthread_mutex_lock(&_mutex_Data_Buf);
    ...
    int MotionSensorDriver::readPowerSensorData(PowerSensorData* powerSensorData) {
        pthread_mutex_lock(&_mutex_Data_Buf);
    ...
    int MotionSensorDriver::readCustomSensorData(CustomSensorData* customSensorData)
    {
    ...
    int MotionSensorDriver::readRangeSensorData(RangeSensorData* rangeSensorData)
    {
        pthread_mutex_lock(&_mutex_Data_Buf);
    ...
    int MotionSensorDriver::readStandardSensorData(StandardSensorData* standardSensorData)
    {
        pthread_mutex_lock(&_mutex_Data_Buf);
    ...
    int MotionSensorDriver::sendMotorCtrlAllCmd(CtrlMethod ctrlMethod, const int cmd1, const int cmd2, const int cmd3, const int cmd4, const int cmd5, const int cmd6, const int time) {
        ...
        return _commInterface.sendCommand(msg, 23);
    }

    int MotionSensorDriver::sendMotorCtrlAllCmd(CtrlMethod ctrlMethod, const int cmd1, const int cmd2, const int cmd3, const int cmd4, const int cmd5, const int cmd6)
    {
        unsigned char msg[255];
        short tempCmd = 0;
        msg[0] = COM_STX0;
        ...
        msg[19] = COM_ETX0;
        msg[20] = COM_ETX1;
        return _commInterface.sendCommand(msg, 21);
    }


    int MotionSensorDriver::sendMotorCtrlCmd(CtrlMethod ctrlMethod, const int channel, const int cmd, const int time)
    {
        unsigned char msg[255];
        ...
        msg[13] = COM_ETX0;
        msg[14] = COM_ETX1;
        return _commInterface.sendCommand(msg, 15);
    }


    int MotionSensorDriver::sendMotorCtrlCmd(CtrlMethod ctrlMethod, const int channel, const int cmd)
    {
        unsigned char msg[255];
        if ((channel < 0) || (channel > 5))
            return -1;
        ...
        msg[10] = COM_ETX0;
        msg[11] = COM_ETX1;
        return _commInterface.sendCommand(msg, 12);
    }


    int MotionSensorDriver::sendServoCtrlAllCmd(const int cmd1, const int cmd2, const int cmd3, const int cmd4, const int cmd5, const int cmd6, const int time)
    {
        unsigned char msg[255];
        short tempCmd = 0;
        short tempTime = time;
    ...
    int MotionSensorDriver::sendServoCtrlAllCmd(const int cmd1, const int cmd2, const int cmd3, const int cmd4, const int cmd5, const int cmd6) {
        unsigned char msg[255];
        short tempCmd = 0;
        msg[0] = COM_STX0;
        msg[1] = COM_STX1;
    ...
    int MotionSensorDriver::sendServoCtrlCmd(const int channel, const int cmd, const int time)
    {
        unsigned char msg[255];
        short tempTime = (short) (time & 0xffff);
        if ((channel < 0) || (channel > 5))
    ...
    int MotionSensorDriver::sendServoCtrlCmd(const int channel, const int cmd)
    {
        unsigned char msg[255];
        if ((channel < 0) || (channel > 5))
            return -1;
    ...
    int MotionSensorDriver::disableMotorCmd(const int channel)
    {
        unsigned char msg[255];
        if ((channel < 0) || (channel > 5))
            return -1;
        ...
        msg[9] = COM_ETX0;
        msg[10] = COM_ETX1;
        return _commInterface.sendCommand(msg, 11);
    }


    int MotionSensorDriver::disableServoCmd(const int channel)
    {
        unsigned char msg[255];
        if ((channel < 0) || (channel > 5))
            return -1;
    ...
    int MotionSensorDriver::setMotorPositionCtrlPID(const int channel, const int kp, const int kd, const int ki)
    {
        unsigned char msg[255];
        if ((channel < 0) || (channel > 5))
            return -1;
        ...
        msg[18] = COM_ETX0;
        msg[19] = COM_ETX1;
        return _commInterface.sendCommand(msg, 20);
    }

    int MotionSensorDriver::setMotorVelocityCtrlPID(const int channel, const int kp, const int kd, const int ki) {
        unsigned char msg[255];
        if ((channel < 0) || (channel > 5))
            return -1;
    ...
    int MotionSensorDriver::setMotorFricCompensation(const int cmd1, const int cmd2, const int cmd3, const int cmd4, const int cmd5, const int cmd6)
    {
        unsigned char msg[255];
    ...
    int MotionSensorDriver::setCustomIO(const int cmd)
    {
        unsigned char msg[255];
    ...
    int MotionSensorDriver::sendPowerCtrlCmd(const int cmd)
    {
        unsigned char msg[255];
